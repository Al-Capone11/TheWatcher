...
public final class TheWatcherRenderer extends LivingEntityRenderer<TheWatcherEntity, PlayerModel<TheWatcherEntity>> {
    ...
    @Override
    public void render(TheWatcherEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
