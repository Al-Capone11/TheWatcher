...
public final class ClientEffects {
    ...
    /** Muffled echo de minería proveniente de una dirección aleatoria. */
    ...
    /** Eco fantasma de un cofre abriéndose desde una dirección aleatoria. */
    ...
    public static void tickFakeCrash(Minecraft client) {
        ...
        fakeCrashTicks--;
        if (fakeCrashTicks == 0 && client.screen instanceof FakeDisconnectScreen) {
